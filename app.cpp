...
int main()
{
    ...
    do
    {
        ...
        {
            int update_id;
            cout << "Enter the update ID of the student you want to update:";
            while (!(cin >> update_id))
            {
                cout << "Invaild input! enter a valid interger:";
                cin.clear();
            ...
            int result = searchStudent(students, update_id);
            if (result == -1)
            {
                cout << "No student found" << endl;
            }
            ...
            {
                cout << "This is the current data of the student:" << endl;
                cout << "ID:" << students[result].s_id << " " << "| " << "NAME:" << students[result].name << " " << "| " << "DEPARTMENT:" << students[result].department << " " << "| " << "CGPI: " << students[result].cgpa << " " << "| " << "ADDRESS:" << students[result].address << endl;
                cout << "Enter the updated data for the slected student:" << endl;
                ...
                students[result].s_id = s_id;
                students[result].name = name;
                students[result].department = department;
                students[result].cgpa = cgpa;
                students[result].address = address;

                saveToFile(students);
                cout << "Your data is updated" << students[result].s_id << " " << students[result].name << endl;
            }
            break;
        }
        case 5:
